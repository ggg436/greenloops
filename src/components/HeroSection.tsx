      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-8">
          ...
          <p className="text-lg text-zinc-600 leading-relaxed max-w-md">
            Optimize your farm operations with AI-powered crop monitoring, weather insights, and data-driven farming decisions.
          </p>
          ...
          <div className="flex items-center gap-16 pt-8">
            <div className="text-center">
              <div className="text-4xl font-medium text-zinc-900 mb-1">1,250+</div>
              <div className="text-sm text-zinc-600">Farms Connected</div>
            </div>
            ...
            <div className="text-center">
              <div className="text-4xl font-medium text-zinc-900 mb-1">500k+</div>
              <div className="text-sm text-zinc-600">Acres Monitored</div>
            </div>
          </div>
        </div>
